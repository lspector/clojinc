...
The same content is also available in the form of a [Gorilla REPL](http://gorilla-repl.org) worksheet, in `worksheet.clj`. The worksheet can also be viewed [here](http://viewer.gorilla-repl.org/view.html?source=github&user=lspector&repo=clojinc&path=master/worksheet.clj).
